...
docker build -t "aimadjaouhar/notes:web-$version_number" -f docker/web.Dockerfile . --no-cache

echo "Building Docker image for api..."
docker build -t "aimadjaouhar/notes:api-$version_number" -f docker/api.Dockerfile . --no-cache

echo "Pushing Docker image web..."
docker push "aimadjaouhar/notes:web-$version_number"

echo "Pushing Docker image api..."
docker push "aimadjaouhar/notes:api-$version_number"
